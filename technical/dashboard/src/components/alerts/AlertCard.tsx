...
export const AlertSummary: React.FC<AlertSummaryProps> = ({ critical, warning, info, total }) => {
  return (
    <div className="grid grid-cols-4 gap-4">
      <div className="alert-summary-card border-sky-600/20 bg-slate-950">
        <p className="text-slate-300 text-sm font-medium">Critical</p>
        <p className="text-2xl font-bold text-sky-300 mt-2">{critical}</p>
      </div>
      <div className="alert-summary-card border-amber-500/20 bg-slate-950">
        <p className="text-slate-300 text-sm font-medium">Warning</p>
        <p className="text-2xl font-bold text-amber-300 mt-2">{warning}</p>
      </div>
      <div className="alert-summary-card border-blue-500/20 bg-slate-950">
        <p className="text-slate-300 text-sm font-medium">Info</p>
        <p className="text-2xl font-bold text-blue-300 mt-2">{info}</p>
      </div>
      <div className="alert-summary-card border-slate-600/40 bg-slate-950">
